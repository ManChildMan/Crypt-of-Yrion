...
public class GolemControllerV2 : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else if (m_mode == SkeletonMode.Attack2)
        {
            UpdateAttack2();
        }
        else if (m_mode == SkeletonMode.Sleep)
        {
            UpdateSleeping();
        }
